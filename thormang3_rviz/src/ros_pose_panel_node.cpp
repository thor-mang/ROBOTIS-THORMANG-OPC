...
#include <stdio.h>
#include "thormang3_rviz/ros_pose_panel_node.h"
...
RosThor3PosePanelNode::RosThor3PosePanelNode()
...
{    
    ...
    clicked_point_sub_ = nh_.subscribe<geometry_msgs::PointStamped>("clicked_point", 0, &RosThor3PosePanelNode::pointStampedCallback, this);
...
// thread run
void RosThor3PosePanelNode::run() {
...
void RosThor3PosePanelNode::pointStampedCallback(const geometry_msgs::PointStamped::ConstPtr &msg)
{
...
void RosThor3PosePanelNode::makeInteractiveMarker(const geometry_msgs::Pose &pose)
{
    if(frame_id_ == "")
    {
    ...
    interactive_marker_server_->setCallback(_interactive_marker.name, boost::bind(&RosThor3PosePanelNode::interactiveMarkerFeedback, this, _1));

    interactive_marker_server_->applyChanges();
}

void RosThor3PosePanelNode::updateInteractiveMarker(const geometry_msgs::Pose &pose)
{
...
void RosThor3PosePanelNode::getInteractiveMarkerPose()
{
...
void RosThor3PosePanelNode::clearInteractiveMarker()
{
...
// publish 3d point
void RosThor3PosePanelNode::publishPoint(const geometry_msgs::Point &point)
{
...
// publish 3d pose
void RosThor3PosePanelNode::publishPose(const geometry_msgs::Pose &pose)
{
...
Eigen::MatrixXd RosThor3PosePanelNode::rpy2rotation(const double &roll, const double &pitch, const double &yaw )
{
...
Eigen::Quaterniond RosThor3PosePanelNode::rpy2quaternion(const Eigen::Vector3d &euler)
{
    return rpy2quaternion(euler[0], euler[1], euler[2]);
}

Eigen::Quaterniond RosThor3PosePanelNode::rpy2quaternion(const double &roll, const double &pitch, const double &yaw )
{
...
Eigen::Quaterniond RosThor3PosePanelNode::rotation2quaternion(const Eigen::MatrixXd &rotation )
{
    Eigen::Matrix3d _rotation3d;
...
Eigen::Vector3d RosThor3PosePanelNode::quaternion2rpy(const geometry_msgs::Quaternion &quaternion)
{
    Eigen::Quaterniond _quaternion;
...
Eigen::MatrixXd RosThor3PosePanelNode::quaternion2rotation(const Eigen::Quaterniond &quaternion )
{
...
Eigen::MatrixXd RosThor3PosePanelNode::rotationX(const double &angle )
{
...
Eigen::MatrixXd RosThor3PosePanelNode::rotationY(const double &angle )
{
    Eigen::MatrixXd _rotation( 3 , 3 );
...
Eigen::MatrixXd RosThor3PosePanelNode::rotationZ(const double &angle )
{
    Eigen::MatrixXd _rotation(3,3);
